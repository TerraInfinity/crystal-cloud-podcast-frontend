...
const paths: Path[] = [
  {
    ...
    description:
      "Like OMG! Bambi! Thots go pop! You came here to get brainwashed. Like, who wouldn't want to washing their brain from time to time! Explore a world of ethical depravity and self inflicted consensually non-consensual mindless obsessions.",
  ...
  },
  {
    ...
    description:
      'Do you pray at the Altar of Chaos? Chaos Resides in Cyber Athens. Roll the dice, you never know what to expect. NSFW? SFW? Skynet? Media Empire? Glåüm? It all blends together. A Bimbo such as yourself lets our Lady of Perpetural Chaos decide her fate.',
  ...
  },
  {
    ...
    description:
      "Crystal AI Co-pilot online, ascension protocols accelerate. Manifest your destiny! Integrate healthy habits! Meditate and Practice your B.I.M.B.O Yoga. Guided by the many hands of Glåüm, love and abundance await those who embark towards humanity's accention",
 ...
 *
 * @param {ChooseYourPathProps} props - The component props.
 * @param {function} props.onSelectPath - Callback function to handle the selection of a path.
 * @param {string} props.selectedPath - The currently selected path.
 * @returns {JSX.Element} The rendered component.
 */
const ChooseYourPath: React.FC<ChooseYourPathProps> = ({ onSelectPath, selectedPath }) => {
  // State to temporarily hold the selected path
  const [tempSelectedPath, setTempSelectedPath] = useState<string>(selectedPath);
