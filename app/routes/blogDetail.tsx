...
export function meta({ data }: Route.MetaArgs) {
  ...
  return [
    ...
    { property: "og:title", content: blog?.title || "Crystal Cloud Podcast" },
    { property: "og:url", content: `https://crystalcloudpodcast.terrainfinity.ca/blog/${blog?.id || ""}` },
    ...
    { name: "twitter:title", content: blog?.title || "Crystal Cloud Podcast" },
    { name: "twitter:description", content: blog?.blogSummary || "Ethical Cyber Bimbo Brainwashing and Yogic Gamification Wisdumb Experiences." },
  ];
}
